 ...
 * 宏强信息科技技术团队(JAVA) SDK
 *
 * Copyright (c) 2016, Inesv Information Technology Co.,Ltd All rights reserved.
 * http://www.inesv.com/java/sdk/
 *
...
public class DateTime implements Serializable {
	 ...
	 */
	public static final String DEFAULT_ORDER_DATE_TIME_FORMAT_PATTERN = "yyyyMMddHHmmss";
	/**
	 * yyyy-MM-dd HH:mm:ss 格式
	 */
	...
	public static String getCurrentDateYMD() {
		SimpleDateFormat sf = new SimpleDateFormat(DEFAULT_DATE_FORMAT_PATTERN);
		return sf.format(new Date());
	...
	public static DateTime parseTime(String time)
		...
		try {
			return DateTime.parseDateTime(time,
					DateTime.DEFAULT_TIME_FORMAT_PATTERN);
		} catch (ParseException e) {
			return DateTime.parseDateTime(time,
					DateTime.DEFAULT_TIME_HHmm_FORMAT_PATTERN);
		}
	}
	...
	public static DateTime parseDate(String date)
		...
		return DateTime.parseDateTime(date,
				DateTime.DEFAULT_DATE_FORMAT_PATTERN);
	}
	...
	public static DateTime parseDateTime(String datetime)
		...
		try {
			result = DateTime.parseDateTime(datetime,
					DateTime.DEFAULT_DATE_TIME_FORMAT_PATTERN);
		} catch (ParseException e) {
			// 解析错误
			result = null;
		}
		...
		if (null == result) {
			try {
				result = DateTime.parseDateTime(datetime,
						DateTime.DEFAULT_DATE_TIME_HHmm_FORMAT_PATTERN);
			} catch (ParseException e) {
				// 解析错误
				result = null;
			}
		...
		if (null == result) {
			try {
				result = DateTime.parseDateTime(datetime,
						DateTime.DEFAULT_DATE_TIME_HH_FORMAT_PATTERN);
			} catch (ParseException e) {
				// 解析错误
				result = null;
			}
